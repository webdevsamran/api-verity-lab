...
#: Fixtures already in this repository that must NOT be reported. Each is a
#: value whose whole purpose is to demonstrate credential *handling*.
MUST_IGNORE = {
    "redaction-test-input": '{"Authorization": "' + _j("Bearer ", "sk-abcdefghijklmnop1234") + '"}',
    "export-test-token": 'store.add_user(org_id, "alice", "owner", token="secret-token-value")',
    "server-fixture-token": 'token = "owner-token-123"',
}
