...
def test_the_documented_tool_count_matches_the_code(spell_number) -> None:
    ...
    exposed = spell_number(len(TOOLS)).capitalize()
    total = spell_number(len(build_parser()._subparsers._group_actions[0].choices))
