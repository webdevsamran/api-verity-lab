...
[Rule packs](https://github.com/webdevsamran/api-verity-lab/blob/main/docs/rule-packs.md) are the right answer for a rule with real
...
committing to anything. [`docs/ebpf-evaluation.md`](https://github.com/webdevsamran/api-verity-lab/blob/main/docs/ebpf-evaluation.md) is
