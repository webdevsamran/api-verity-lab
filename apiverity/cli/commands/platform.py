...
_RULE_GUIDE: tuple[tuple[str, str, str], ...] = (
    ...
    ("BRK-STREAM-", "Streaming media", "docs/streaming.md"),
    ("COMPAT-", "Cross-version compatibility", "docs/check-rules.md"),
    ("GQL-DRIFT-", "GraphQL drift", "docs/check-rules.md"),
    ("GQL-", "GraphQL compatibility", "docs/check-rules.md"),
    ("PROTO-", "Protobuf compatibility", "docs/check-rules.md"),
    ("SPEC-STREAM-", "Streaming media", "docs/streaming.md"),
    ("SPEC-REF-", "Reference resolution", "docs/check-rules.md"),
    ("SPEC-WSDL-", "WSDL and SOAP documents", "docs/check-rules.md"),
    ("SPEC-", "Document structure", "docs/check-rules.md"),
    ("SWAGGER2-", "Swagger 2.0", "docs/check-rules.md"),
    ("ASYNCAPI-", "AsyncAPI", "docs/check-rules.md"),
    ("DRIFT-", "Runtime drift", "docs/check-rules.md"),
    ("GHOST-", "Ghost routes", "docs/check-rules.md"),
    ("MCP-POISON-", "MCP tool poisoning", "docs/mcp-poisoning.md"),
    ("MCP-ANNOTATION-", "MCP tool poisoning", "docs/mcp-poisoning.md"),
    ("MCP-AUTH-", "MCP authentication", "docs/mcp-drift.md"),
    ("MCP-SHADOW-", "MCP inventory", "docs/mcp-inventory.md"),
    ("MCP-INVENTORY-", "MCP inventory", "docs/mcp-inventory.md"),
    ("MCP-LOCK-", "MCP lockfile", "docs/mcp-lock.md"),
    ("MCP-DRIFT-", "MCP runtime and conformance", "docs/mcp-drift.md"),
    ("MCP-CONF-", "MCP runtime and conformance", "docs/mcp-drift.md"),
    ("MCP-CALL-", "MCP runtime and conformance", "docs/mcp-drift.md"),
    ("MCP-", "MCP manifests", "docs/check-rules.md"),
    ("BUDGET-", "Agent call budgets", "docs/call-budgets.md"),
    ("WF-", "Workflows", "docs/workflow-authoring.md"),
    ("CONSUMER-", "Consumers", "docs/blast-radius.md"),
    ...
    ("SEMVER-", "Semantic versioning", "docs/check-rules.md"),
