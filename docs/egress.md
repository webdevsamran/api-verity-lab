...
|---|---|---|
| `apiverity/cli/commands/platform.py` | `notify --send`, `freeze` against a server | `httpx.get` (platform.py:217), `httpx.post` (platform.py:1037), `httpx.post` (platform.py:228), `httpx.request` (platform.py:230) |
